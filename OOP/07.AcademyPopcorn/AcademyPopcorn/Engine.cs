...
namespace AcademyPopcorn
{
    public class Engine
    {
        ...
        // 2. Implement a constructor, which takes it as an additional parameter.
        ...
        private void AddRacket(GameObject obj)
        {
            ...
            // 3. Remove last add object Racket in allObjects and staticObjects
        ...
        public virtual void Run()
        {
            while (true)
            {
                ...
                // 2. Make the sleep time a field in the Engine 
