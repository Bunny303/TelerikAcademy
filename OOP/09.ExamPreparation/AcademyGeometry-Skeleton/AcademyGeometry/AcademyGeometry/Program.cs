...
namespace GeometryAPI
{
    ...
    { 
        ...
        public Vector3D GetNormal()
        {
            ...
            Vector3D pointA = new Vector3D(center.X+this.Radius,center.Y,center.Z);
            Vector3D pointB = new Vector3D(center.X,center.Y+this.Radius,center.Z);
            Vector3D normal = Vector3D.CrossProduct(center-pointA,center-pointB);
            normal.Normalize();
            return normal;
        }
    ...
    public class Cylinder : Figure, IVolumeMeasurable, IAreaMeasurable
    {
        ...
        public double GetArea()
        {
            double topBaseArea = Math.PI * Radius * Radius;
            double bottomBaseArea = topBaseArea;
            double h = TopCenter.Z - BottomCenter.Z;
            return topBaseArea+bottomBaseArea+2*Math.PI*Radius*h;
        }

        public double GetVolume()
        {
            double baseArea = Math.PI * Radius * Radius;
            double h = TopCenter.Z - BottomCenter.Z; // (TopCenter-BottomCenter).Magnitude
            return baseArea * h;
        }
    ...
    public class FigureControllerAdvanced : FigureController
    {
                ...
                case "cylinder":
                    {
                        ...
                        currentFigure = new Cylinder(topCenter,bottomCenter, radius);
                        break;
                    }
            }
...
namespace AcademyGeometry
{
    class Program
    {
        ...
        {
            return new FigureControllerAdvanced();
        }
