namespace Telerik.ILS.Common
{
    ...
    public static class StringExtensions
    {
        ...
        /// <returns>Hexadecimal representation of the string</returns>
        public static string ToMd5Hash(this string input)
        {
            var md5Hash = MD5.Create();

            var convertedInput = md5Hash.ComputeHash(Encoding.UTF8.GetBytes(input));

            var collectedConvertedInputs = new StringBuilder();

            for (int i = 0; i < convertedInput.Length; i++)
            {
                collectedConvertedInputs.Append(convertedInput[i].ToString("x2"));
            }

            return collectedConvertedInputs.ToString();
        }
        ...
        /// <summary>
        /// Try to parse inputed string to 16-bit signed integer
        /// </summary>
        /// <param name="input">Input string</param>
        ...
        /// <summary>
        /// Try to parse inputed string to 32-bit signed integer
        /// </summary>
        /// <param name="input">Input string</param>
        ...
        /// <summary>
        /// Try to parse inputed string to 64-bit signed integer
        /// </summary>
        /// <param name="input">Input string</param>
        ...
        /// <summary>
        /// Try to parse inputed string to System.DateTime data
        /// </summary>
        /// <param name="input">Input string</param>
        ...
        /// <summary>
        /// Change cyrillic letters with the latin ones .
        /// </summary>
        /// <param name="input">String with cyrillic letters to be replaced</param>
        /// <returns>Replaced string with latin letters</returns>
        ...
        /// <summary>
        /// Change latin letters with the cyrillic ones .
        /// </summary>
        /// <param name="input">String with latin letters to be replaced</param>
        /// <returns>Replaced string with cyrillic letters</returns>
        ...
        /// <summary>
        /// Converts input text from cyrillic to latin letters.
        /// Replaces all white spaces with "-"
        ...
        /// of the input text and ends at the less than input text length or
        ...
        /// in the dictionary we will have the dictionary value returned. If not return "application/octet-stream";
        /// </summary>
        /// <param name="fileExtension">used to check if is contained
        /// as key in the dictionary</param>
        /// <returns>value from the dictionary corresponding to the input key or "application/octet-stream"</returns>
